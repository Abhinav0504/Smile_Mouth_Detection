...
//
//    // Print first 2 rows of the tensor
//    std::cout << "\nFirst 2 Rows of Tensor Data:" << std::endl;
//    for (int row = 0; row < 2; ++row) {
//        std::cout << "[ ";
//        for (int col = 0; col < width1; ++col) {
//            cv::Vec3f pixel = image_data.tensor_data.at<cv::Vec3f>(row, col);
//            std::cout << "[" << pixel[0] << ", " << pixel[1] << ", " << pixel[2] << "] ";
//        }
//        std::cout << "]" << std::endl;
//    }
//
//// Print last 2 rows of the tensor
//    std::cout << "\nLast 2 Rows of Tensor Data:" << std::endl;
//    for (int row = height1 - 2; row < height1; ++row) {
//        std::cout << "[ ";
//        for (int col = 0; col < width1; ++col) {
//            cv::Vec3f pixel = image_data.tensor_data.at<cv::Vec3f>(row, col);
//            std::cout << "[" << pixel[0] << ", " << pixel[1] << ", " << pixel[2] << "] ";
...
//
//
//    cv::Mat input_with_batch(1, image_data.tensor_data.total(), CV_32FC1, image_data.tensor_data.data);
//
//
