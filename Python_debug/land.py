...
"""
land.py
@description: loads the tensorflowlite model for landmarks detection
...
from typess import Detection, Landmark, Rect
from face import FaceIndex
...
class FaceLandmark:
    ...
    def __init__(
        ...
        self.model_path = Config.model_land
